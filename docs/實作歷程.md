...
* check service health，拆分不同 docker compose and sleep 5
* implement user token spend and query times to postgreSQL
* implement chat history of backend
* auto set langfuse config by docker compose.obs and .env
* add rule and alertmanager and env issue (2 days)
* add api layer probes for mcpclient and note servercie
* add storage layer probes for note service and arxiv service, email ervice
* add redis layer probes for note service, mcpclient service
* add basic api calling and system to grafana to visualize
* Visulaize with grafana , Observability with Langfuse, Monitoring with Protheums


**TODO:**
* add prometheus on mcpclient and noteserver
* 增加告警
